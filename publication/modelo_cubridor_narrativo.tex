...
\section{Problema multiobjetivo de cobertura de conjuntos}

El problema se formula como una adaptación explícita del \textit{set covering
problem} (SCP). Sea el universo de relaciones que se desea explicar:
\[
...
Para comparar métodos se maximiza el hipervolumen:
\[
...
volumen en tres dimensiones. Un mayor hipervolumen indica un frente que combina
mejor parsimonia, importancia nodal y bajo daño estructural por remoción de
aristas.
